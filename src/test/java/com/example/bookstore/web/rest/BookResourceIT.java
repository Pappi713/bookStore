...
class BookResourceIT {
    ...
    private static final Long UPDATED_PAGE_NO = 2L;
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().title(DEFAULT_TITLE).pageNo(DEFAULT_PAGE_NO);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().title(UPDATED_TITLE).pageNo(UPDATED_PAGE_NO);
        return book;
    }
    ...
    void createBook() throws Exception {
        ...
        assertThat(testBook.getPageNo()).isEqualTo(DEFAULT_PAGE_NO);
    }
    ...
    void getAllBooks() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.[*].pageNo").value(hasItem(DEFAULT_PAGE_NO.intValue())));
    }
    ...
    void getBook() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.pageNo").value(DEFAULT_PAGE_NO.intValue()));
    }
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).pageNo(UPDATED_PAGE_NO);
        ...
        assertThat(testBook.getPageNo()).isEqualTo(UPDATED_PAGE_NO);
    }
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).pageNo(UPDATED_PAGE_NO);
