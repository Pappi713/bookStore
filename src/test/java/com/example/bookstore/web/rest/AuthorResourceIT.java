...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).age(DEFAULT_AGE).gender(DEFAULT_GENDER);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).age(UPDATED_AGE).gender(UPDATED_GENDER);
        return author;
    }
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).age(UPDATED_AGE).gender(UPDATED_GENDER);
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.age(UPDATED_AGE);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).age(UPDATED_AGE).gender(UPDATED_GENDER);
