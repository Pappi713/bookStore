...
class PublisherResourceIT {
    ...
    public static Publisher createEntity(EntityManager em) {
        Publisher publisher = new Publisher().name(DEFAULT_NAME).location(DEFAULT_LOCATION);
        return publisher;
    }
    ...
    public static Publisher createUpdatedEntity(EntityManager em) {
        Publisher publisher = new Publisher().name(UPDATED_NAME).location(UPDATED_LOCATION);
        return publisher;
    }
    ...
    void createPublisher() throws Exception {
        ...
        assertThat(testPublisher.getLocation()).isEqualTo(DEFAULT_LOCATION);
    }
    ...
    void putNewPublisher() throws Exception {
        ...
        updatedPublisher.name(UPDATED_NAME).location(UPDATED_LOCATION);
        ...
        assertThat(testPublisher.getLocation()).isEqualTo(UPDATED_LOCATION);
    }
    ...
    void fullUpdatePublisherWithPatch() throws Exception {
        ...
        partialUpdatedPublisher.name(UPDATED_NAME).location(UPDATED_LOCATION);
